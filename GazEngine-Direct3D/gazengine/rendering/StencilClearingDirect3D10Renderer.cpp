...
void StencilClearingDirect3D10Renderer::render(const Capsule& model)
{
...
void StencilClearingDirect3D10Renderer::render(const Cylinder& model)
{
	renderer->render(model);
}

void StencilClearingDirect3D10Renderer::render(const Line2& model)
{
	renderer->render(model);
}
...
void StencilClearingDirect3D10Renderer::render(const Sphere& model)
{
	renderer->render(model);
}
...
void StencilClearingDirect3D10Renderer::render(const Torus& model)
{
	renderer->render(model);
}
