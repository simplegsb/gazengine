...
void GDIRenderingEngine::addLight(Light*)
{
}
...
const Camera* GDIRenderingEngine::getCamera() const
{
	return NULL;
}

const Vector4& GDIRenderingEngine::getClearingColour() const
{
...
void GDIRenderingEngine::setCamera(Camera*)
{
}

void GDIRenderingEngine::setClearingColour(const Vector4& clearingColour)
{
...
void GDIRenderingEngine::setRendererRoot(const Renderer& renderer, const SimpleTree& node)
{
